...
update "USER"
set role='COACH'
where role='USER' and "USER".email in ('lee2000@hexschooltest.io','muscle@hexschooltest.io','starplatinum@hexschooltest.io');
...
VALUES
	(
	(SELECT "COACH".id FROM "COACH" JOIN "USER" ON "USER".id="COACH".user_id where "USER".email='lee2000@hexschooltest.io'),
	(select id from "SKILL" where name='重訓')
	),
	(
	(SELECT "COACH".id FROM "COACH" JOIN "USER" ON "USER".id="COACH".user_id where "USER".email='muscle@hexschooltest.io'),
	(select id from "SKILL" where name='重訓')
	),
	(
	(SELECT "COACH".id FROM "COACH" JOIN "USER" ON "USER".id="COACH".user_id where "USER".email='starplatinum@hexschooltest.io'),
	(select id from "SKILL" where name='重訓')
	),
	(
	(SELECT "COACH".id FROM "COACH" JOIN "USER" ON "USER".id="COACH".user_id where "USER".email='muscle@hexschooltest.io'),
...
(
	SELECT "COACH".id
	from "COACH" join "USER" on "COACH".user_id="USER".id
